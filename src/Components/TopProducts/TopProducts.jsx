...
const ProductsData = [
    {
        ...
        img: Img1,
        title: "Casual Wear",
       description: "Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptatum, sint a. Sint.Voluptatum, sint a. Sint.",
    },{
        id: 2,
        img: Img2,
        title: "Printed shirt",
      ...
      <div>
          <div className="container">
              ...
              <div className="text-left mb-24">
                  ...
                  <h1
                      dats-aos="fade-up" className="text-3xl font-bold ">
                      Best Products
                  </h1>
              ...
              {/* Body section */}
              <div  className='grid grid-col-1 sm:grid-col-2 md:grid-cols-3 gap-20 md:gap-5 place-items-center'>
